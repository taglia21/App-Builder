  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="w-64 bg-slate-900 text-white p-4 flex flex-col">
        <div className="text-xl font-bold mb-8 px-4">SystemTestApp</div>
        ...
        <nav className="flex-1 space-y-2">
          ...
          <Link href="/dashboard/items" className="flex items-center space-x-2 px-4 py-2 hover:bg-slate-800 rounded transition">
            <FileText size={20} />
            <span>Items</span>
          </Link>
