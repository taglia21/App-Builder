...
### AutomationWorkflows
- `GET /api/v1/automationworkflows/` - List all
- `POST /api/v1/automationworkflows/` - Create new
- `GET /api/v1/automationworkflows/{id}` - Get by ID
- `PUT /api/v1/automationworkflows/{id}` - Update
- `DELETE /api/v1/automationworkflows/{id}` - Delete
