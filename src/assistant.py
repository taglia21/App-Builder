...
""")
        ...
        self.console.print()
        self.console.print("[green]✓ Got it![/green] Let me research your idea...")
...
"""
                ...
                self.console.print("[red]Error parsing AI response. Retrying...[/red]")
    ...
    def generate_application(self) -> bool:
        ...
        try:
            ...
            with Progress(
                ...
                progress.add_task("[cyan]Generating codebase...", total=None)
